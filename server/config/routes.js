...
module.exports = function(app) {
	...
	router.get('/api/library/book/:id', controllers.libraries.getLibBookById);
	router.put('/api/library/book', auth.isInRole('admin', 'librarian', 'libraryOwner'), controllers.libraries.updateLibBook);
